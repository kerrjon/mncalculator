...
namespace MnCalculator.Models
{
    public class CalculatorResult
    {
        ...
        public static CalculatorResult Create(ChildSupportForm input)
        {
            ...
            model.ParentA.ProRataBasicSupportObligation = (double)Math.Round(input.ParentAGrossIncome / (input.ParentAGrossIncome + input.ParentBGrossIncome) * model.CombinedBasicSupportObligation, 2);
            model.ParentB.ProRataBasicSupportObligation = (double)Math.Round(input.ParentBGrossIncome / (input.ParentAGrossIncome + input.ParentBGrossIncome) * model.CombinedBasicSupportObligation, 2);
